 ...
 * http://stackoverflow.com/questions/5332149/jdbc-scriptrunner-java-lang-
 * nullpointerexception?tab=active#tab-top
 */
/*
 ...
 * statements. This way you
 * can execute scripts that contain some TRIGGER creation code. New version
 * using REGEXPs! Latest
 * modification: Cater for a NullPointerException while parsing. Date: Feb 16,
 * 2011, 11:48 EET
 */
/*
 * Slightly modified version of the com.ibatis.common.jdbc.ScriptRunner class
 * from the iBATIS Apache
 * project. Only removed dependency on Resource class and a constructor
 */
/*
 * Copyright 2004 Clinton Begin Licensed under the Apache License, Version 2.0
 * (the "License"); you may
